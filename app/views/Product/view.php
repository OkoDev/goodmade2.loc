...
<!--                                </li> -->
                    ...
                    <?php
                    $curr = \goodmade\App::$app->getProperty('currency');
                    $cats = \goodmade\App::$app->getProperty('cats')
                    ;?>
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price">
                                <?php if($product->old_price * $curr['value']): ?>
                                    <sup><small><del><b>
                                                    <?=$curr['symbol_left'];?>
                            ...
                            <form class="form-inline">
                                ...
                                <div class="form-group">
                                    <label for="quantity"><b>Pcs.</b></label>
                                    <b>
                                        <input type="number" class="form-control" size="4" value="1" name="quantity" min="1" step="1" >
                                    </b>
                                </div>
                                <a id="productAdd"
                                   data-id="<?$product->id;?>"
                                   href="cart/add?id=<?$product->id;?>"
                                   class="btn add-cart item_add add-to-cart-link">
                                    ADD TO CART
                                </a>
                                </div>
                            </form>
                ...
                <?php if($related): ?>
                    <div class="latestproducts">
                        <div class="product-one">
                            <h3>С этим товаром также приобретают:</h3>
                                        ...
                                        <div class="product-bottom">
                                            ...
                                            <h4>
                                                ...
                                                <span class="item_price">
                                                    <?php if($item['old_price'] * $curr['value']): ?>
                                                         <sup><small><del><b>
                                                            <?=$curr['symbol_left'];?>
                ...
                <?php if($recentlyViewed): ?>
                    <div class="latestproducts">
                        <div class="product-one">
                            ...
                            <?php foreach($recentlyViewd as $item): ?>
                                <div class="col-md-4 product-left p-left">
                                    <div class="product-main simpleCart_shelfItem">
                                        <a href="product/<?=$item['alias'];?>" class="mask"><img class="img-responsive zoom-img" src="images/<?=$item['img'];?>" alt="" /></a>
                                        <div class="product-bottom">
